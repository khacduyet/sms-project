    ...
    return (
        <ScrollView>
            <View>
                ...
                <View style={styles.items}>
                    <TextInput style={styles.inputtext}
                        onChangeText={(e) => setForm(e, 'HoKhauThuongTruDiaChi', 'itemSYLL')}
                ...
                <View style={styles.items}>
                    <TextInput style={styles.inputtext}
                        label={'Ngày vào đoàn'}
                        variant="standard"
                        value={formatDateStringGMT(syll?.itemSYLL?.NgayKetNapDoan, 'dd/mm/yyyy')}
                        onFocus={() => {
                            setNameProp({
                                prop: 'NgayKetNapDoan',
                                propParent: 'itemSYLL',
                ...
                <View style={styles.items}>
                    <TextInput style={styles.inputtext}
                        label={'Ngày vào đảng'}
                        variant="standard"
                        value={formatDateStringGMT(syll?.itemSYLL?.NgayThamGiaDang, 'dd/mm/yyyy')}
                        onFocus={() => {
                            setNameProp({
                ...
                <View style={{ flex: 1, flexDirection: "row", justifyContent: 'center' }}>
                    <Button icon="check" mode="contained" onPress={GhiLai}
                        style={{ width: '75%' }}>
                        Xác nhận
                    </Button>
                </View>
